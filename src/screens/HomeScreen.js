  ...
  return (
    <View style={{flex: 1}}>
          ...
          {!loading && user ? (
            <View
              ...
              <ScrollView
                ...
                contentContainerStyle={{paddingTop: 240, paddingBottom: 75}}>
                {/* <View
                style={{
                ...
                {/* Groups Section */}
                {/* <View style={{flex: 0.4, height: null, width: null}}></View> */}
                ...
                <View style={styles.card}>
                  ...
                  <TouchableOpacity
                    ...
                    <View>
                      <Text style={styles.nextScreenIcon}>{'>'}</Text>
                    </View>
                  </TouchableOpacity>
                </View>
      ...
      <Modal
        ...
        onRequestClose={() => setActionModalVisible(!isActionModalVisible)}
        // onRequestClose={() => {
